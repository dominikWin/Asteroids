...
public class Asteroid {
	...
	while (true) {
	    ...
	    if (Vector2d.distance(loc, Game.getInstance().getWorld()
		    .getPlayer().getLocation()) > Game.WIDTH / 6)
		return loc;
	}
    }
	...
	Game.getInstance()
		.getWorld()
		.addAsteroid(
			new Asteroid(new Vector2d(location.getX(), location
				.getY()), Math.random() * 360, rotationSpeed,
				size / 2));
	Game.getInstance()
		.getWorld()
		.addAsteroid(
