...
public class DistortedPolygon extends Polygon {
	...
	public DistortedPolygon(Vector2d location, int sides, int radius, double rotation) {
	...
	public DistortedPolygon(Vector2d location, int sides, int radius, double rotation, double minChange, double maxChange) {
		super(location, sides, radius, rotation);
		distances = new ArrayList<>();
		for (int i = 0; i < sides; i++)
